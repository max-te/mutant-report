var MutationTestElements = function(exports) {
  "use strict";
  /**
   * @license
  ...
  const r$7 = (t2) => new n$5("string" == typeof t2 ? t2 : t2 + "", void 0, s$4), S$1 = (s2, o2) => {
    if (e$6)
   ...
   * SPDX-License-Identifier: BSD-3-Clause
   */
  const { is: i$2, defineProperty: e$5, getOwnPropertyDescriptor: r$6, getOwnPropertyNames: h$4, getOwnPropertySymbols: o$5, getPrototypeOf: n$4 } = Object, a$1 = globalThis, c$3 = a$1.trustedTypes, l$1 = c$3 ? c$3.emptyScript : "", p$2 = a$1.reactiveElementPolyfillSupport, d$1 = (t2, s2) => t2, u$3 = { toAttribute(t2, s2) {
    switch (s2) {
      case Boolean:
        t2 = t2 ? l$1 : null;
        break;
    ...
    return i2;
  } }, f$3 = (t2, s2) => !i$2(t2, s2), y$1 = { attribute: true, type: String, converter: u$3, reflect: false, hasChanged: f$3 };
  ...
  let b$1 = class b extends HTMLElement {
    ...
    static finalize() {
      ...
      if (this.finalized = true, this._$Ei(), this.hasOwnProperty(d$1("properties"))) {
        const t3 = this.properties, s2 = [...h$4(t3), ...o$5(t3)];
        for (const i2 of s2)
    ...
    _$EC(t2, s2) {
      ...
      if (void 0 !== e2 && true === i2.reflect) {
        const r2 = (void 0 !== i2.converter?.toAttribute ? i2.converter : u$3).toAttribute(s2, i2.type);
    ...
    _$AK(t2, s2) {
      ...
      if (void 0 !== e2 && this._$Em !== e2) {
        const t3 = i2.getPropertyOptions(e2), r2 = "function" == typeof t3.converter ? { fromAttribute: t3.converter } : void 0 !== t3.converter?.fromAttribute ? t3.converter : u$3;
        this._$Em = e2, this[e2] = r2.fromAttribute(s2, t3.type), this._$Em = null;
      }
    }
    requestUpdate(t2, s2, i2) {
      if (void 0 !== t2) {
        if (i2 ??= this.constructor.getPropertyOptions(t2), !(i2.hasChanged ?? f$3)(this[t2], s2))
          return;
        this.P(t2, s2, i2);
      }
...
\f\r"'\`<>=]|("|')|))|$)`, "g"), p$1 = /'/g, g = /"/g, $ = /^(?:script|style|textarea|title)$/i, y = (t2) => (i2, ...s2) => ({ _$litType$: t2, strings: i2, values: s2 }), x = y(1), b = y(2), w = Symbol.for("lit-noChange"), T = Symbol.for("lit-nothing"), A = /* @__PURE__ */ new WeakMap(), E = r$5.createTreeWalker(r$5, 129);
  function C(t2, i2) {
  ...
  const P = (t2, i2) => {
    ...
    for (let i3 = 0; i3 < s2; i3++) {
      ...
      l2 += c2 === f$2 ? s3 + n$3 : d2 >= 0 ? (o2.push(a2), s3.slice(0, d2) + e$4 + s3.slice(d2) + h$3 + x2) : s3 + h$3 + (-2 === d2 ? i3 : x2);
    }
  ...
  class S {
    ...
    u(t2) {
      const { el: { content: i2 }, parts: s2 } = this._$AD, e2 = (t2?.creationScope ?? r$5).importNode(i2, true);
      E.currentNode = e2;
    ...
    _$AI(t2, i2 = this, s2, e2) {
      ...
      if (void 0 === h2)
        ...
        for (t2 = h2[0], n2 = 0; n2 < h2.length - 1; n2++)
          r2 = N(this, e3[s2 + n2], i2, n2), r2 === w && (r2 = this._$AH[n2]), o2 ||= !c$2(r2) || r2 !== this._$AH[n2], r2 === T ? t2 = T : t2 !== T && (t2 += (r2 ?? "") + h2[n2 + 1]), this._$AH[n2] = r2;
      }
      o2 && !e2 && this.j(t2);
    }
    j(t2) {
   ...
   * SPDX-License-Identifier: BSD-3-Clause
   */
  const o$3 = { attribute: true, type: String, converter: u$3, reflect: false, hasChanged: f$3 }, r$3 = (t2 = o$3, e2, r2) => {
  ...
  function compareNames(a2, b2) {
    ...
    return sortValue(a2).localeCompare(sortValue(b2));
  }
  var CharacterCodes;
  ...
  exports.MutationTestReportAppComponent = class MutationTestReportAppComponent extends RealTimeElement {
    ...
    initializeSse() {
      ...
      this.source.addEventListener("finished", () => {
        this.source?.close();
        this.applyChanges();
        this.sseSubscriptions.forEach((s2) => s2.unsubscribe());
      });
    }
    applyChanges() {
  ...
  __publicField$d(exports.MutationTestReportAppComponent, "styles", [globals, r$7(theme), tailwind]);
  __decorateClass$d([
    n$2({ attribute: false })
  ], exports.MutationTestReportAppComponent.prototype, "report", 2);
  __decorateClass$d([
    n$2({ attribute: false })
  ], exports.MutationTestReportAppComponent.prototype, "rootModel", 2);
  __decorateClass$d([
    n$2()
  ], exports.MutationTestReportAppComponent.prototype, "src", 2);
  __decorateClass$d([
    n$2()
  ], exports.MutationTestReportAppComponent.prototype, "sse", 2);
  __decorateClass$d([
    n$2({ attribute: false })
  ], exports.MutationTestReportAppComponent.prototype, "errorMessage", 2);
  __decorateClass$d([
    n$2({ attribute: false })
  ], exports.MutationTestReportAppComponent.prototype, "context", 2);
  __decorateClass$d([
    n$2()
  ], exports.MutationTestReportAppComponent.prototype, "path", 2);
  __decorateClass$d([
    n$2({ attribute: "title-postfix" })
  ], exports.MutationTestReportAppComponent.prototype, "titlePostfix", 2);
  __decorateClass$d([
    n$2({ reflect: true })
  ], exports.MutationTestReportAppComponent.prototype, "theme", 2);
  __decorateClass$d([
    n$2({ attribute: false })
  ], exports.MutationTestReportAppComponent.prototype, "themeBackgroundColor", 1);
  __decorateClass$d([
    n$2()
  ], exports.MutationTestReportAppComponent.prototype, "title", 1);
  exports.MutationTestReportAppComponent = __decorateClass$d([
    t$2("mutation-test-report-app")
  ], exports.MutationTestReportAppComponent);
  /**
   * @license
   * Copyright 2020 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */
  const { I: t$1 } = z, f$1 = (o2) => void 0 === o2.strings, s$1 = () => document.createComment(""), r$1 = (o2, i2, n2) => {
    const e2 = o2._$AA.parentNode, l2 = void 0 === i2 ? o2._$AB : i2._$AA;
    if (void 0 === n2) {
      const i3 = e2.insertBefore(s$1(), l2), c2 = e2.insertBefore(s$1(), l2);
      n2 = new t$1(i3, c2, o2, o2.options);
    } else {
      ...
      if (t2)
        if (Array.isArray(r2))
          for (let i3 = e2; i3 < r2.length; i3++)
            s(r2[i3], false), o$2(r2[i3]);
        else
          null != r2 && (s(r2, false), o$2(r2));
      else
        s(this, i2);
  }
  const c$1 = (i2) => {
  ...
  class f extends i {
    ...
    _$AO(i2, t2 = true) {
      i2 !== this.isConnected && (this.isConnected = i2, i2 ? this.reconnected?.() : this.disconnected?.()), t2 && (s(this, i2), o$2(this));
    }
    setValue(t2) {
      if (f$1(this._$Ct))
  ...
  const o$1 = /* @__PURE__ */ new WeakMap(), n = e$3(class extends f {
    render(i2) {
      return T;
    }
    update(i2, [s2]) {
      const e2 = s2 !== this.Y;
      return e2 && void 0 !== this.Y && this.rt(void 0), (e2 || this.lt !== this.ct) && (this.Y = s2, this.ht = i2.options?.host, this.rt(this.ct = i2.element)), T;
    }
    rt(t2) {
      if ("function" == typeof this.Y) {
        const i2 = this.ht ?? globalThis;
        let s2 = o$1.get(i2);
        void 0 === s2 && (s2 = /* @__PURE__ */ new WeakMap(), o$1.set(i2, s2)), void 0 !== s2.get(this.Y) && this.Y.call(this.ht, void 0), s2.set(this.Y, t2), void 0 !== t2 && this.Y.call(this.ht, t2);
      } else
        this.Y.value = t2;
    }
    get lt() {
  ...
  function gte(a2, b2) {
    return a2.line > b2.line || a2.line === b2.line && a2.column >= b2.column;
  }
  ...
  let FileComponent = class extends RealTimeElement {
    ...
    render() {
      ...
      >
        <code ${n(this.codeRef)} class="flex language-${this.model.language}">
    ...
    renderMutantDots(mutants) {
      return mutants?.length ? mutants.map(
        (mutant) => b`<svg mutant-id="${mutant.id}" class="mutant-dot ${this.selectedMutant?.id === mutant.id ? "selected" : mutant.status}" height="10" width="12">
  ...
  const u = (e2, s2, t2) => {
    ...
    update(s2, [t2, r2, c2]) {
      const d2 = p(s2), { values: p$12, keys: a2 } = this.dt(t2, r2, c2);
      if (!Array.isArray(d2))
      ...
      for (; x2 <= j2 && k2 <= w$1; )
        if (null === d2[x2])
          ...
          v$12[w$1] = v(d2[x2], p$12[w$1]), r$1(s2, v$12[w$1 + 1], d2[x2]), x2++, w$1--;
        else if (h2[j2] === a2[k2])
          v$12[k2] = v(d2[j2], p$12[k2]), r$1(s2, d2[x2], d2[j2]), j2--, k2++;
        else if (void 0 === m$12 && (m$12 = u(a2, k2, w$1), y2 = u(h2, x2, j2)), m$12.has(h2[x2]))
          if (m$12.has(h2[j2])) {
            const e2 = y2.get(a2[k2]), t3 = void 0 !== e2 ? d2[e2] : null;
            if (null === t3) {
              const e3 = r$1(s2, d2[x2]);
              v(e3, p$12[k2]), v$12[k2] = e3;
            } else
              v$12[k2] = v(t3, p$12[k2]), r$1(s2, d2[x2], t3), d2[e2] = null;
            k2++;
          } else
            h$2(d2[j2]), j2--;
        else
  ...
  let MutationTestReportTestMetricsTable = class extends RealTimeElement {
    ...
    renderCell(column, metrics) {
      ...
      return x`<td
      class="${e({ "font-bold": column.isBold ?? false, [backgroundColoringClass]: true })} py-4 text-center group-hover:bg-gray-200"
  ...
  let TestFileComponent = class extends RealTimeElement {
    ...
    renderTestDots(tests) {
      return tests?.length ? tests.map(
        (test) => b`<svg test-id="${test.id}" class="cursor-pointer test-dot ${this.selectedTest === test ? "selected" : test.status}" @click=${(ev) => {
          ev.stopPropagation();
          this.toggleTest(test);
        }} height="10" width="12">
  ...
  let MutationTestReportFileIconComponent = class extends s$2 {
    ...
    get cssClass() {
      return e({ [this.language?.toString() ?? "unknown"]: this.isFile, test: this.isTestFile });
    }
    render() {
      if (!this.isFile) {
      ...
      if (!this.language) {
        return b`<svg aria-label="file" class="octicon octicon-file" viewBox="0 0 12 16" version="1.1" width="12" height="16" role="img"><path fill-rule="evenodd" d="M6 5H2V4h4v1zM2 8h7V7H2v1zm0 2h7V9H2v1zm0 2h7v-1H2v1zm10-7.5V14c0 .55-.45 1-1 1H1c-.55 0-1-.45-1-1V2c0-.55.45-1 1-1h7.5L12 4.5zM11 5L8 2H1v12h10V5z"></path></svg>`;
      }
      switch (this.language) {
        case ProgrammingLanguage.csharp:
          return b`<svg class="${this.cssClass}" aria-label="cs" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"><g><path d="M7.1 15.9c0-1.3.2-2.4.6-3.4.4-1 .9-1.8 1.6-2.5.7-.7 1.5-1.2 2.4-1.6s1.9-.5 2.9-.5 1.9.2 2.7.6c.8.4 1.5.9 2 1.4l-2.2 2.5c-.4-.3-.7-.6-1.1-.7-.4-.1-.8-.3-1.4-.3-.5 0-.9.1-1.3.3-.4.2-.8.5-1.1.9s-.5.8-.7 1.4c-.2.6-.3 1.2-.3 1.9 0 1.5.3 2.6 1 3.3.7.8 1.5 1.2 2.6 1.2.5 0 1-.1 1.4-.3.4-.2.8-.5 1.1-.9l2.2 2.5c-.7.8-1.4 1.3-2.2 1.7-.8.4-1.7.6-2.7.6s-2-.2-2.9-.5-1.7-.8-2.4-1.5-1.1-1.7-1.5-2.7c-.5-.9-.7-2.1-.7-3.4z"/><path d="M21.8 17.1h-1l-.4 2.4h-1.2l.4-2.4h-1.2V16h1.5l.2-1.6h-1.3v-1.1h1.5l.4-2.4h1.2l-.4 2.4h1l.4-2.4h1.2l-.4 2.4H25v1.1h-1.6l-.2 1.6h1.3v1.1h-1.6l-.4 2.4h-1.2c0 .1.5-2.4.5-2.4zm-.8-1h1l.2-1.6h-1l-.2 1.6z"/></g></svg>`;
        case ProgrammingLanguage.html:
          return b`<svg class="${this.cssClass}" aria-label="html" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"><path d="M8 15l6-5.6V12l-4.5 4 4.5 4v2.6L8 17v-2zm16 2.1l-6 5.6V20l4.6-4-4.6-4V9.3l6 5.6v2.2z"/></svg>`;
        case ProgrammingLanguage.java:
          return b`<svg class="${this.cssClass}" aria-label="java" xmlns="http://www.w3.org/2000/svg" viewBox="-4 -4 20 20"><path class="cls-1" d="M6 0a6 6 0 1 0 6 6 6 6 0 0 0-6-6zm2.14 6.8a2.16 2.16 0 0 1-2.29 2.41 2.5 2.5 0 0 1-2-.87l.73-.92a1.52 1.52 0 0 0 1.23.59c.66 0 1.06-.42 1.06-1.32V2.8h1.26z"/></svg>`;
        ...
        case ProgrammingLanguage.vue:
          return b`<svg class="${this.cssClass}" aria-label="vue" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 1000"><path d="M600 495.9l159.1-275.4h-84.4L600 349.7l-74.6-129.2h-84.5z"/><path d="M793.7 220.5L600 555.9 406.3 220.5H277l323 559 323-559z"/></svg>`;
  ...
  let MutationTestReportThemeSwitchComponent = class extends s$2 {
    render() {
      return x`<span class="cursor-help underline decoration-dotted" title="${this.title}"><slot></slot></span>`;
    }
  };
  __publicField$1(MutationTestReportThemeSwitchComponent, "styles", [tailwind]);
  __decorateClass$1([
    n$2({ attribute: true })
  ], MutationTestReportThemeSwitchComponent.prototype, "title", 2);
  MutationTestReportThemeSwitchComponent = __decorateClass$1([
    t$2("mte-tooltip")
