// node_modules/mutation-testing-elements/dist/index.js
var C = function(t2, i2) {
  if (!Array.isArray(t2) || !t2.hasOwnProperty("raw"))
    throw Error("invalid template strings array");
  return s$3 !== undefined ? s$3.createHTML(i2) : i2;
};
var N = function(t2, i2, s3 = t2, e3) {
  if (i2 === w)
    return i2;
  let h2 = e3 !== undefined ? s3._$Co?.[e3] : s3._$Cl;
  const o2 = c$2(i2) ? undefined : i2._$litDirective$;
  return h2?.constructor !== o2 && (h2?._$AO?.(false), o2 === undefined ? h2 = undefined : (h2 = new o2(t2), h2._$AT(t2, s3, e3)), e3 !== undefined ? (s3._$Co ??= [])[e3] = h2 : s3._$Cl = h2), h2 !== undefined && (i2 = N(t2, h2._$AS(t2, i2.values), h2, e3)), i2;
};
var n$2 = function(t2) {
  return (e3, o2) => typeof o2 == "object" ? r$3(t2, e3, o2) : ((t3, e4, o3) => {
    const r2 = e4.hasOwnProperty(o3);
    return e4.constructor.createProperty(o3, r2 ? { ...t3, wrapped: true } : t3), r2 ? Object.getOwnPropertyDescriptor(e4, o3) : undefined;
  })(t2, e3, o2);
};
var r$2 = function(r2) {
...
var normalize = function(input, projectRoot, factory) {
...
var determineCommonBasePath = function(fileNames) {
...
var compareNames = function(a2, b3) {
...
var computeLineStarts = function(text) {
  const result = [];
  let pos = 0;
  let lineStart = 0;
...
var assertSourceFileDefined$1 = function(sourceFile) {
  if (sourceFile === undefined) {
    throw new Error("mutant.sourceFile was not defined");
  }
};
var assertSourceDefined = function(source) {
  if (source === undefined) {
    throw new Error("sourceFile.source is undefined");
  }
};
var assertSourceFileDefined = function(sourceFile) {
  if (sourceFile === undefined) {
    throw new Error("test.sourceFile was not defined");
  }
};
var assertLocationDefined = function(location) {
  if (location === undefined) {
    throw new Error("test.location was not defined");
  }
};
var calculateMutationTestMetrics = function(result) {
...
var calculateRootMetrics = function(name, files, calculateMetrics) {
...
var calculateDirectoryMetrics = function(name, files, calculateMetrics) {
...
var calculateFileMetrics = function(fileName, file, calculateMetrics) {
  return new MetricsResult(fileName, [], calculateMetrics([file]), file);
};
var toChildModels = function(files, calculateMetrics) {
...
var relate = function(mutants, tests) {
...
var countTestFileMetrics = function(testFile) {
...
var countFileMetrics = function(fileResult) {
...
var __read = function(o2, n3) {
  ...
  try {
    while ((n3 === undefined || n3-- > 0) && !(r2 = i2.next()).done)
      ar.push(r2.value);
  } catch (error) {
    e3 = { error };
  } finally {
...
var scheduleIterable = function(input, scheduler) {
  return new Observable(function(subscriber) {
    ...
    return function() {
      return isFunction(iterator$1 === null || iterator$1 === undefined ? undefined : iterator$1.return) && iterator$1.return();
    };
  });
};
...
var createCustomEvent = function(eventName, detail, opts) {
  return new CustomEvent(eventName, { detail, ...opts });
};
var renderIf = function(condition, consequence) {
  if (condition) {
...
var renderIfPresent = function(value, factory) {
...
var getContextClassForStatus = function(status) {
  switch (status) {
    case "Killed":
      return "success";
    case "NoCoverage":
...
var getContextClassForTestStatus = function(status) {
  switch (status) {
...
var getEmojiForTestStatus = function(status) {
  switch (status) {
    case TestStatus.Killing:
...
var getEmojiForStatus = function(status) {
  switch (status) {
    case "Killed":
      return renderEmoji("\u2705", status);
    case "NoCoverage":
...
var toAbsoluteUrl = function(...fragments) {
  const url = new URL(window.location.href);
  return new URL(`#${fragments.filter(Boolean).join("/")}`, url).href;
};
var plural = function(items) {
  if (items.length > 1) {
    return "s";
  }
  return "";
};
var describeLocation = function({ fileName, location }) {
  return fileName ? `${fileName}${location ? `:${location.start.line}:${location.start.column}` : ""}` : "";
};
var scrollToCodeFragmentIfNeeded = function(el) {
...
var h$1 = function(i2) {
  this._$AN !== undefined ? (o$2(this), this._$AM = i2, r(this)) : this._$AM = i2;
};
var n$1 = function(i2, t2 = false, e3 = 0) {
  const r2 = this._$AH, h2 = this._$AN;
  if (h2 !== undefined && h2.size !== 0)
    if (t2)
      if (Array.isArray(r2))
        for (let i3 = e3;i3 < r2.length; i3++)
          s2(r2[i3], false), o$2(r2[i3]);
      else
        r2 != null && (s2(r2, false), o$2(r2));
    else
      s2(this, i2);
};
...
var determineLanguage = function(fileName) {
...
var transformHighlightedLines = function(source, visitor) {
...
var findDiffIndices = function(original, mutated) {
...
var gte = function(a2, b3) {
  return a2.line > b3.line || a2.line === b3.line && a2.column >= b3.column;
};
var renderDots = function(dots, finalDots) {
...
var t$4 = globalThis;
var e$6 = t$4.ShadowRoot && (t$4.ShadyCSS === undefined || t$4.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype;
var s$4 = Symbol();
var o$6 = new WeakMap;
var n$5 = class n {
  ...
  get styleSheet() {
    ...
    const s3 = this.t;
    if (e$6 && t2 === undefined) {
      const e3 = s3 !== undefined && s3.length === 1;
      e3 && (t2 = o$6.get(s3)), t2 === undefined && ((this.o = t2 = new CSSStyleSheet).replaceSync(this.cssText), e3 && o$6.set(s3, t2));
    }
    return t2;
  }
  toString() {
...
var r$7 = (t2) => new n$5(typeof t2 == "string" ? t2 : t2 + "", undefined, s$4);
var S$1 = (s3, o2) => {
  if (e$6)
    ...
    for (const e3 of o2) {
      ...
      n3 !== undefined && o3.setAttribute("nonce", n3), o3.textContent = e3.cssText, s3.appendChild(o3);
    }
};
var c$4 = e$6 ? (t2) => t2 : (t2) => t2 instanceof CSSStyleSheet ? ((t3) => {
  let e3 = "";
  for (const s3 of t3.cssRules)
    e3 += s3.cssText;
  return r$7(e3);
})(t2) : t2;
var { is: i$2, defineProperty: e$5, getOwnPropertyDescriptor: r$6, getOwnPropertyNames: h$4, getOwnPropertySymbols: o$5, getPrototypeOf: n$4 } = Object;
var a$1 = globalThis;
var c$3 = a$1.trustedTypes;
var l$1 = c$3 ? c$3.emptyScript : "";
var p$2 = a$1.reactiveElementPolyfillSupport;
var d$1 = (t2, s3) => t2;
var u$3 = { toAttribute(t2, s3) {
  switch (s3) {
    case Boolean:
      t2 = t2 ? l$1 : null;
      break;
...
var f$3 = (t2, s3) => !i$2(t2, s3);
var y$1 = { attribute: true, type: String, converter: u$3, reflect: false, hasChanged: f$3 };
Symbol.metadata ??= Symbol("metadata"), a$1.litPropertyMetadata ??= new WeakMap;
var b$1 = class b extends HTMLElement {
  ...
  static createProperty(t2, s3 = y$1) {
    if (s3.state && (s3.attribute = false), this._$Ei(), this.elementProperties.set(t2, s3), !s3.noAccessor) {
      ...
      r2 !== undefined && e$5(this.prototype, t2, r2);
    }
  }
  ...
  static finalize() {
    ...
    for (const [t3, s3] of this.elementProperties) {
      ...
      i2 !== undefined && this._$Eh.set(i2, t3);
    }
  ...
  static finalizeStyles(s3) {
    ...
    if (Array.isArray(s3)) {
      ...
      s3 !== undefined && i2.push(c$4(s3));
    return i2;
  }
  static _$Eu(t2, s3) {
    const i2 = s3.attribute;
    return i2 === false ? undefined : typeof i2 == "string" ? i2 : typeof t2 == "string" ? t2.toLowerCase() : undefined;
  }
  constructor() {
  ...
  _$E_() {
    const t2 = new Map, s3 = this.constructor.elementProperties;
  ...
  _$EC(t2, s3) {
    ...
    if (e3 !== undefined && i2.reflect === true) {
      const r2 = (i2.converter?.toAttribute !== undefined ? i2.converter : u$3).toAttribute(s3, i2.type);
      this._$Em = t2, r2 == null ? this.removeAttribute(e3) : this.setAttribute(e3, r2), this._$Em = null;
    }
  }
  _$AK(t2, s3) {
    const i2 = this.constructor, e3 = i2._$Eh.get(t2);
    if (e3 !== undefined && this._$Em !== e3) {
      const t3 = i2.getPropertyOptions(e3), r2 = typeof t3.converter == "function" ? { fromAttribute: t3.converter } : t3.converter?.fromAttribute !== undefined ? t3.converter : u$3;
  ...
  P(t2, s3, i2) {
    this._$AL.has(t2) || this._$AL.set(t2, s3), i2.reflect === true && this._$Em !== t2 && (this._$Ej ??= new Set).add(t2);
  }
  async _$ET() {
    ...
    if (!this.hasUpdated) {
      ...
      if (t3.size > 0)
        for (const [s4, i2] of t3)
          i2.wrapped !== true || this._$AL.has(s4) || this[s4] === undefined || this.P(s4, this[s4], i2);
    }
    let t2 = false;
    const s3 = this._$AL;
    try {
...
b$1.elementStyles = [], b$1.shadowRootOptions = { mode: "open" }, b$1[d$1("elementProperties")] = new Map, b$1[d$1("finalized")] = new Map, p$2?.({ ReactiveElement: b$1 }), (a$1.reactiveElementVersions ??= []).push("2.0.4");
var t$3 = globalThis;
var i$1 = t$3.trustedTypes;
var s$3 = i$1 ? i$1.createPolicy("lit-html", { createHTML: (t2) => t2 }) : undefined;
var e$4 = "$lit$";
var h$3 = `lit\$${(Math.random() + "").slice(9)}\$`;
var o$4 = "?" + h$3;
var n$3 = `<${o$4}>`;
var r$5 = document;
var l = () => r$5.createComment("");
var c$2 = (t2) => t2 === null || typeof t2 != "object" && typeof t2 != "function";
var a = Array.isArray;
var u$2 = (t2) => a(t2) || typeof t2?.[Symbol.iterator] == "function";
var d = "[ 	\n\f\r]";
var f$2 = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g;
var v$1 = /-->/g;
var _ = />/g;
var m$1 = RegExp(`>|${d}(?:([^\\s"'>=/]+)(${d}*=${d}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|\$)`, "g");
var p$1 = /'/g;
var g = /"/g;
...
var A = new WeakMap;
var E = r$5.createTreeWalker(r$5, 129);
var P = (t2, i2) => {
  const s3 = t2.length - 1, o2 = [];
  let r2, l2 = i2 === 2 ? "<svg>" : "", c2 = f$2;
  for (let i3 = 0;i3 < s3; i3++) {
    const s4 = t2[i3];
    let a2, u2, d2 = -1, y2 = 0;
    for (;y2 < s4.length && (c2.lastIndex = y2, u2 = c2.exec(s4), u2 !== null); )
      y2 = c2.lastIndex, c2 === f$2 ? u2[1] === "!--" ? c2 = v$1 : u2[1] !== undefined ? c2 = _ : u2[2] !== undefined ? ($.test(u2[2]) && (r2 = RegExp("</" + u2[2], "g")), c2 = m$1) : u2[3] !== undefined && (c2 = m$1) : c2 === m$1 ? u2[0] === ">" ? (c2 = r2 ?? f$2, d2 = -1) : u2[1] === undefined ? d2 = -2 : (d2 = c2.lastIndex - u2[2].length, a2 = u2[1], c2 = u2[3] === undefined ? m$1 : u2[3] === '"' ? g : p$1) : c2 === g || c2 === p$1 ? c2 = m$1 : c2 === v$1 || c2 === _ ? c2 = f$2 : (c2 = m$1, r2 = undefined);
    const x2 = c2 === m$1 && t2[i3 + 1].startsWith("/>") ? " " : "";
    l2 += c2 === f$2 ? s4 + n$3 : d2 >= 0 ? (o2.push(a2), s4.slice(0, d2) + e$4 + s4.slice(d2) + h$3 + x2) : s4 + h$3 + (d2 === -2 ? i3 : x2);
  }
  return [C(t2, l2 + (t2[s3] || "<?>") + (i2 === 2 ? "</svg>" : "")), o2];
};
...
class V {
  constructor({ strings: t2, _$litType$: s3 }, n3) {
    ...
    if (this.el = V.createElement(f2, n3), E.currentNode = this.el.content, s3 === 2) {
    ...
    for (;(r2 = E.nextNode()) !== null && d2.length < u2; ) {
      if (r2.nodeType === 1) {
        ...
        if (r2.data === o$4)
          ...
          let t3 = -1;
          for (;(t3 = r2.data.indexOf(h$3, t3 + 1)) !== -1; )
...
class S {
  ...
  u(t2) {
    ...
    for (;l2 !== undefined; ) {
      if (o2 === l2.index) {
        let i3;
        l2.type === 2 ? i3 = new M(h2, h2.nextSibling, this, t2) : l2.type === 1 ? i3 = new l2.ctor(h2, l2.name, l2.strings, this, t2) : l2.type === 6 && (i3 = new L(h2, this, t2)), this._$AV.push(i3), l2 = s3[++n3];
      }
  ...
  p(t2) {
    ...
    for (const s3 of this._$AV)
      s3 !== undefined && (s3.strings !== undefined ? (s3._$AI(t2, s3, i2), i2 += s3.strings.length - 2) : s3._$AI(t2[i2])), i2++;
  }
}
...
class M {
  ...
  constructor(t2, i2, s3, e3) {
    this.type = 2, this._$AH = T, this._$AN = undefined, this._$AA = t2, this._$AB = i2, this._$AM = s3, this.options = e3, this._$Cv = e3?.isConnected ?? true;
  }
  get parentNode() {
    let t2 = this._$AA.parentNode;
    const i2 = this._$AM;
    return i2 !== undefined && t2?.nodeType === 11 && (t2 = i2.parentNode), t2;
  }
  get startNode() {
    return this._$AA;
  }
  ...
  _$AI(t2, i2 = this) {
    t2 = N(this, t2, i2), c$2(t2) ? t2 === T || t2 == null || t2 === "" ? (this._$AH !== T && this._$AR(), this._$AH = T) : t2 !== this._$AH && t2 !== w && this._(t2) : t2._$litType$ !== undefined ? this.$(t2) : t2.nodeType !== undefined ? this.T(t2) : u$2(t2) ? this.k(t2) : this._(t2);
  }
  S(t2) {
  ...
  $(t2) {
    const { values: i2, _$litType$: s3 } = t2, e3 = typeof s3 == "number" ? this._$AC(t2) : (s3.el === undefined && (s3.el = V.createElement(C(s3.h, s3.h[0]), this.options)), s3);
  ...
  _$AC(t2) {
    ...
    return i2 === undefined && A.set(t2.strings, i2 = new V(t2)), i2;
  }
  k(t2) {
  ...
  setConnected(t2) {
    this._$AM === undefined && (this._$Cv = t2, this._$AP?.(t2));
  }
}
...
class R {
  ...
  constructor(t2, i2, s3, e3, h2) {
    this.type = 1, this._$AH = T, this._$AN = undefined, this.element = t2, this.name = i2, this._$AM = e3, this.options = h2, s3.length > 2 || s3[0] !== "" || s3[1] !== "" ? (this._$AH = Array(s3.length - 1).fill(new String), this.strings = s3) : this._$AH = T;
  }
...
class k extends R {
  ...
  j(t2) {
    this.element[this.name] = t2 === T ? undefined : t2;
  }
}
...
class L {
  constructor(t2, i2, s3) {
    this.element = t2, this.type = 6, this._$AN = undefined, this._$AM = i2, this.options = s3;
  }
  get _$AU() {
    return this._$AM._$AU;
  }
...
var z = { P: e$4, A: h$3, C: o$4, M: 1, L: P, R: S, D: u$2, V: N, I: M, H: R, N: H, U: I, B: k, F: L };
var Z = t$3.litHtmlPolyfillSupport;
...
var j = (t2, i2, s3) => {
  ...
  if (h2 === undefined) {
    ...
    e3._$litPart$ = h2 = new M(i2.insertBefore(l(), t3), t3, undefined, s3 ?? {});
  }
  return h2._$AI(t2), h2;
};
var s$2 = class s extends b$1 {
  constructor() {
...
var r$4 = globalThis.litElementPolyfillSupport;
r$4?.({ LitElement: s$2 });
(globalThis.litElementVersions ??= []).push("4.0.4");
var t$2 = (t2) => (e3, o2) => {
  o2 !== undefined ? o2.addInitializer(() => {
    customElements.define(t2, e3);
  }) : customElements.define(t2, e3);
};
var o$3 = { attribute: true, type: String, converter: u$3, reflect: false, hasChanged: f$3 };
var r$3 = (t2 = o$3, e3, r2) => {
  const { kind: n3, metadata: i2 } = r2;
  let s3 = globalThis.litPropertyMetadata.get(i2);
  if (s3 === undefined && globalThis.litPropertyMetadata.set(i2, s3 = new Map), s3.set(r2.name, t2), n3 === "accessor") {
    const { name: o2 } = r2;
    return { set(r3) {
      const n4 = e3.get.call(this);
      e3.set.call(this, r3), this.requestUpdate(o2, n4, t2);
    }, init(e4) {
      return e4 !== undefined && this.P(o2, undefined, t2), e4;
    } };
  }
  if (n3 === "setter") {
    const { name: o2 } = r2;
...
var tailwind = r$7(tailwindCss);
var prismjs = r$7(prismjsCss);
var globals = r$7(globalsCss);
...
var DRAWER_HALF_OPEN_SIZE = 120;
var MutationTestReportDrawer = class extends s$2 {
  get toggleMoreLabel() {
    switch (this.mode) {
      case "half":
      ...
      <div class="mx-6">
        <header class="w-full py-4">
          <h2>
            ...
            ${renderIf(this.hasDetail, x`<button data-testId="btnReadMoreToggle" class="ml-2 align-middle" @click="${this.toggleReadMore}"
...
var UPDATE_CYCLE_TIME = 100;
var MutationTestReportAppComponent = class extends RealTimeElement {
  ...
  updateContext() {
    if (this.rootModel) {
      const findResult = (root, path2) => {
        return path2.reduce((model, currentPathPart) => model?.childResults.find((child) => child.name === currentPathPart), root);
      };
  ...
  renderTabs() {
    if (this.rootModel?.testMetrics) {
      ...
      ].map(({ type, isActive, text }) => x`<li class="mr-2" role="presentation">
                  <a
...
var { I: t$1 } = z;
var f$1 = (o2) => o2.strings === undefined;
var s$1 = () => document.createComment("");
var r$1 = (o2, i2, n3) => {
  const e3 = o2._$AA.parentNode, l2 = i2 === undefined ? o2._$AB : i2._$AA;
  if (n3 === undefined) {
    ...
    if (c2) {
      let t3;
      n3._$AQ?.(o2), n3._$AM = o2, n3._$AP !== undefined && (t3 = o2._$AU) !== i3._$AU && n3._$AP(t3);
    }
    if (t2 !== l2 || c2) {
      let o3 = n3._$AA;
      for (;o3 !== t2; ) {
...
var v = (o2, t2, i2 = o2) => (o2._$AI(t2, i2), o2);
var u$1 = {};
var m = (o2, t2 = u$1) => o2._$AH = t2;
var p = (o2) => o2._$AH;
var h$2 = (o2) => {
  o2._$AP?.(false, true);
  let t2 = o2._$AA;
...
var e$3 = (t2) => (...e3) => ({ _$litDirective$: t2, values: e3 });
...
var o$1 = new WeakMap;
var n2 = e$3(class extends f {
  render(i2) {
    return T;
  }
  update(i2, [s3]) {
    const e3 = s3 !== this.Y;
    return e3 && this.Y !== undefined && this.rt(undefined), (e3 || this.lt !== this.ct) && (this.Y = s3, this.ht = i2.options?.host, this.rt(this.ct = i2.element)), T;
  }
  rt(t2) {
    if (typeof this.Y == "function") {
      const i2 = this.ht ?? globalThis;
      let s3 = o$1.get(i2);
      s3 === undefined && (s3 = new WeakMap, o$1.set(i2, s3)), s3.get(this.Y) !== undefined && this.Y.call(this.ht, undefined), s3.set(this.Y, t2), t2 !== undefined && this.Y.call(this.ht, t2);
    } else
      this.Y.value = t2;
  }
  get lt() {
    return typeof this.Y == "function" ? o$1.get(this.ht ?? globalThis)?.get(this.Y) : this.Y?.value;
  }
  disconnected() {
    this.lt === this.ct && this.rt(undefined);
  }
  reconnected() {
    this.rt(this.ct);
  }
});
var ProgrammingLanguage = ((ProgrammingLanguage2) => {
...
var e$1 = class e extends i {
  ...
  render(r2) {
    if (r2 === T || r2 == null)
      return this._t = undefined, this.it = r2;
    if (r2 === w)
      return r2;
    if (typeof r2 != "string")
...
var diffOldClass = "diff-old";
var diffNewClass = "diff-new";
var FileComponent = class extends RealTimeElement {
  codeRef = e$2();
  constructor() {
    super();
    this.filters = [];
  ...
  renderMutantDots(mutants) {
    return mutants?.length ? mutants.map((mutant) => b2`<svg mutant-id="${mutant.id}" class="mutant-dot ${this.selectedMutant?.id === mutant.id ? "selected" : mutant.status}" height="10" width="12">
  ...
  update(changes) {
    ...
    if (changes.has("model") && this.model || changes.has("selectedMutantStates")) {
      ...
      if (this.selectedMutant && !this.mutants.includes(this.selectedMutant) && changes.has("selectedMutantStates") && this.selectedMutantsHaveChanged(changes.get("selectedMutantStates") ?? [])) {
        this.toggleMutant(this.selectedMutant);
      }
    }
...
var c = e$3(class extends i {
  ...
  dt(e3, s3, t2) {
    let r2;
    t2 === undefined ? t2 = s3 : s3 !== undefined && (r2 = s3);
    const l2 = [], o2 = [];
    let i2 = 0;
    for (const s4 of e3)
  ...
  update(s3, [t2, r2, c2]) {
    ...
    for (;x2 <= j2 && k2 <= w$1; )
      ...
      else if (m$12 === undefined && (m$12 = u(a2, k2, w$1), y2 = u(h2, x2, j2)), m$12.has(h2[x2]))
        if (m$12.has(h2[j2])) {
          const e3 = y2.get(a2[k2]), t3 = e3 !== undefined ? d2[e3] : null;
          if (t3 === null) {
...
var MutationTestReportBreadcrumbComponent = class extends s$2 {
  get rootName() {
    switch (this.view) {
      case View.mutant:
        return "All files";
  ...
  renderBreadcrumbItems() {
    if (this.path) {
      ...
      return c(path, (item) => item, (item, index) => {
...
var style$5 = ".step-button{align-items:center;border-radius:.375rem;display:inline-flex;margin-right:.5rem;--tw-bg-opacity:1;background-color:rgb(var(--mut-primary-600,2 132 199)/var(--tw-bg-opacity));padding:.25rem;text-align:center;--tw-text-opacity:1;color:rgb(var(--mut-white,255 255 255)/var(--tw-text-opacity))}.step-button:hover{--tw-bg-opacity:1;background-color:rgb(var(--mut-primary-700,3 105 161)/var(--tw-bg-opacity))}.step-button:focus{outline:2px solid #0000;outline-offset:2px;--tw-ring-offset-shadow:var(--tw-ring-inset) 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color);--tw-ring-shadow:var(--tw-ring-inset) 0 0 0 calc(2px + var(--tw-ring-offset-width)) var(--tw-ring-color);box-shadow:var(--tw-ring-offset-shadow),var(--tw-ring-shadow),var(--tw-shadow,0 0 #0000);--tw-ring-opacity:1;--tw-ring-color:rgb(var(--mut-primary-500,14 165 233)/var(--tw-ring-opacity))}";
...
var FileStateFilterComponent = class extends RealTimeElement {
  updated(changedProperties) {
  ...
  render() {
    return x`
      <div class="sticky top-offset z-10 flex flex-row bg-white py-6">
        ...
        ${renderIf(this.filters?.length, c(this.filters, (filter) => filter.status, (filter) => x`
...
var MutationTestReportThemeSwitchComponent$1 = class MutationTestReportThemeSwitchComponent extends s$2 {
...
var renderDrawer = ({ hasDetail, mode }, content) => x`<mte-drawer
...
var describeTest = (test) => `${test.name}${test.sourceFile && test.location ? ` (${describeLocation(test)})` : ""}`;
var whitespacePreserving = (content) => x`<span class="whitespace-pre-wrap">${content}</span>`;
var MutationTestReportDrawerMutant = class extends RealTimeElement {
  constructor() {
    super();
    this.mode = "closed";
  }
  render() {
    return renderDrawer({ hasDetail: Boolean(this.mutant?.killedByTests?.length || this.mutant?.coveredByTests?.length), mode: this.mode }, renderIfPresent(this.mutant, (mutant) => x`
  ...
  renderSummary() {
    return renderSummaryContainer(x`${this.mutant?.killedByTests?.[0] ? renderSummaryLine(x`${renderEmoji("\uD83C\uDFAF", "killed")} Killed by:
            ${this.mutant.killedByTests?.[0].name}${this.mutant.killedByTests.length > 1 ? `(and ${this.mutant.killedByTests.length - 1} more)` : ""}`) : T}
      ${renderIf(this.mutant?.static, renderSummaryLine(x`${renderEmoji("\uD83D\uDDFF", "static")} Static mutant`))}
      ${renderIfPresent(this.mutant?.coveredByTests, (coveredTests) => renderSummaryLine(x`${renderEmoji("\u2602\uFE0F", "umbrella")} Covered by ${coveredTests.length}
          test${plural(coveredTests)}${this.mutant?.status === "Survived" ? " (yet still survived)" : ""}`))}
      ${renderIf(this.mutant?.statusReason?.trim(), renderSummaryLine(x`${renderEmoji("\uD83D\uDD75\uFE0F", "spy")} ${whitespacePreserving(this.mutant.statusReason)}`, `Reason for the ${this.mutant.status} status`))}
      ${renderIfPresent(this.mutant?.description, (description) => renderSummaryLine(x`${renderEmoji("\uD83D\uDCD6", "book")} ${whitespacePreserving(description)}`))}`);
  }
  renderDetail() {
    return x`<ul class="mb-6 mr-12">
      ${this.mutant?.killedByTests?.map((test) => renderDetailLine("This mutant was killed by this test", x`${renderEmoji("\uD83C\uDFAF", "killed")} ${describeTest(test)}`))}
...
var style$3 = "main{padding-bottom:var(--mte-drawer-height-half-open)}";
...
var MutationTestReportMutantViewComponent = class extends RealTimeElement {
  constructor() {
    super();
...
var style$2 = "main{padding-bottom:var(--mte-drawer-height-half-open)}";
...
var MutationTestReportTestViewComponent = class extends RealTimeElement {
  constructor() {
    super();
    this.drawerMode = "closed";
  }
...
var e2 = e$3(class extends i {
  constructor(t$12) {
    if (super(t$12), t$12.type !== t.ATTRIBUTE || t$12.name !== "class" || t$12.strings?.length > 2)
  ...
  update(s3, [i2]) {
    if (this.st === undefined) {
      this.st = new Set, s3.strings !== undefined && (this.nt = new Set(s3.strings.join(" ").split(/\s/).filter((t2) => t2 !== "")));
      for (const t2 in i2)
...
var MutationTestReportTestMetricsTable = class extends RealTimeElement {
  constructor() {
    super();
    this.currentPath = [];
    this.thresholds = {
  ...
  renderTableHeadRow() {
    return x`<thead class="border-b border-gray-200 text-center text-sm">
      <tr>
        ...
        ${c(this.columns, (column) => column.key, (column) => this.renderTableHead(column))}
      </tr>
    </thead>`;
  }
...
var TestFileComponent = class extends RealTimeElement {
  constructor() {
    super();
    this.filters = [];
    this.lines = [];
  ...
  renderTestList() {
    ...
    if (testsToRenderInTheList.length) {
      return x`<ul class="max-w-6xl">
        ${c(testsToRenderInTheList, (test) => test.id, (test) => x`<li class="my-3">
              <button
  ...
  renderCode() {
    if (this.model?.source) {
      ...
      return x`<pre id="report-code-block" class="line-numbers flex rounded-md p-1"><code class="flex language-${determineLanguage(this.model.name)}">
      <table>
  ...
  renderTestDots(tests) {
    return tests?.length ? tests.map((test) => b2`<svg test-id="${test.id}" class="cursor-pointer test-dot ${this.selectedTest === test ? "selected" : test.status}" @click=${(ev) => {
      ev.stopPropagation();
      this.toggleTest(test);
    }} height="10" width="12">
...
var describeMutant = (mutant) => x`<code>${mutant.getMutatedLines()}</code> (${describeLocation(mutant)})`;
var MutationTestReportDrawerTestComponent = class extends RealTimeElement {
  constructor() {
    super();
    this.mode = "closed";
  }
  render() {
    return renderDrawer({ hasDetail: Boolean(this.test?.killedMutants?.length || this.test?.coveredMutants?.length), mode: this.mode }, renderIfPresent(this.test, (test) => x`
          <span class="align-middle text-lg" slot="header"
            >${getEmojiForTestStatus(test.status)} ${test.name} [${test.status}]
  ...
  renderSummary() {
    return renderSummaryContainer(x`${this.test?.killedMutants?.[0] ? renderSummaryLine(x`${renderEmoji("\uD83C\uDFAF", "killed")} Killed:
            ${describeMutant(this.test.killedMutants?.[0])}${this.test.killedMutants.length > 1 ? x` (and ${this.test.killedMutants.length - 1} more)` : ""}`) : T}
      ${renderIfPresent(this.test?.coveredMutants, (coveredMutants) => renderSummaryLine(x`${renderEmoji("\u2602\uFE0F", "umbrella")} Covered ${coveredMutants.length}
          mutant${plural(coveredMutants)}${this.test?.status === TestStatus.Covering ? " (yet didn't kill any of them)" : ""}`))}`);
  }
  renderDetail() {
    return x`<ul class="mb-6 mr-12">
      ${this.test?.killedMutants?.map((mutant) => renderDetailLine("This test killed this mutant", x`${renderEmoji("\uD83C\uDFAF", "killed")} ${describeMutant(mutant)}`))}
...
var MutationTestReportFileIconComponent = class extends s$2 {
  get language() {
...
var MutationTestReportThemeSwitchComponent2 = class extends s$2 {
  render() {
...
var _observer;
var _renderSmallParts;
var renderSmallParts_fn;
var _renderSmallPart;
var renderSmallPart_fn;
var _renderParts;
var renderParts_fn;
var _renderPart;
var renderPart_fn;
var _getMetrics;
var getMetrics_fn;
var _colorFromMetric;
var colorFromMetric_fn;
var _calculatePercentage;
var calculatePercentage_fn;
var ResultStatusBar = class extends s$2 {
  constructor() {
    super();
    ...
    __privateAdd(this, _observer, undefined);
    this.detected = 0;
    this.noCoverage = 0;
    this.pending = 0;
    this.survived = 0;
...
_calculatePercentage = new WeakSet;
...
async function mount() {
  ...
  app.report = await fetch("report.json").then((r2) => r2.json());
  app["id"] = "app";
